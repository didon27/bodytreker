...
const SearchInput = ({ onChangeText, value, placeholder }) => {
    return (
        <View row flex centered style={{ backgroundColor: '#f4f4f4', height: 40, borderRadius: 14, paddingHorizontal: 8, }}>
            ...
            <TextInput value={value} onChangeText={onChangeText} placeholder={placeholder} placeholderTextColor={'grey'} style={{ flex: 1, marginRight: 10, paddingLeft: 12, fontSize: 16 }} />
