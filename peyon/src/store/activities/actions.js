...
export const activitiesActions = {
  ...
  //FRIENDS
  getFriendsActivities: (payload, refresh) => ({
    type: activitiesConstants.GET_FRIENDS_ACTIVITIES,
    payload,
    refresh,
  }),
  getFriendsActivitiesSuccess: (payload, refresh) => ({
    type: activitiesConstants.GET_FRIENDS_ACTIVITIES_SUCCESS,
    payload,
    refresh,
  }),

  getFriendsActivitiesFailure: error => ({
    type: activitiesConstants.GET_FRIENDS_ACTIVITIES_FAILURE,
    error,
  }),
